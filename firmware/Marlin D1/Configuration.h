...
#define CUSTOM_MENDEL_NAME "Delta3030"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 80, 86}  // default steps per unit for Kossel (GT2, 20 tooth) 320 gt2
...
#define DEFAULT_XYJERK                5.0    // (mm/sec), used to be 20
